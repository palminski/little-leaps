...
public class LevelStart : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (GameController.Instance.Checkpoint != currentLevel && !GameController.Instance.TimerMoving)
        {
            ...
            if (worldDialogue)
            {
                ...
                string timeForLevel = ConvertFloatToTime(GameController.Instance.BonusTimer);

                string newText = worldDialogue.startingText.Replace("[TIMER]", timeForLevel);
