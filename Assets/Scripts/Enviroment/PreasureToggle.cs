...
public class PreasureToggle : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            if (AudioController.Instance != null) AudioController.Instance.PlayEnemySpikeStart();
    ...
    private IEnumerator WaitAndAddDanger()
    {
        ...
        if (AudioController.Instance != null) AudioController.Instance.PlayEnemySpikeDeploy();
